...
export const CONFIG_DEFS: ConfigDef[] = [
  ...
  { key: 'DELIVERY_CLAIM_WINDOW_MINUTES', label: 'Thời gian chờ shipper nhận đơn', description: 'Đơn giao NGAY không có ai nhận trong khoảng này sẽ bị huỷ và báo người nhận đặt lại. Đơn HẸN GIỜ chờ tới giờ hẹn.', group: 'Giao hàng', unit: 'phút', min: 5, max: 240, default: 30 },
