...
export const CONFIG_DEFS: ConfigDef[] = [
  ...
  { key: 'CAMPAIGN_ALLOW_EARLY_START_AND_CHECKIN', label: 'Cho phep bat dau/diem danh som', description: 'Dung de test hoac to chuc van hanh som: dat 1 de cho bat dau chien dich va diem danh truoc ngay/gio du kien khi da dat nguong nhan su admin cau hinh. Dat 0 de giu luat van hanh dung lich.', group: 'Chiến dịch', unit: '0/1', min: 0, max: 1, default: 0 },
