...
export const CONFIG_DEFS: ConfigDef[] = [
  ...
  { key: 'CAMPAIGN_REQUIRE_SUPPLIER_CONFIRMATION', label: 'Duyệt chiến dịch khi NCC đã nhận lời', description: 'Bật: admin chỉ duyệt được chiến dịch khi MỌI nguyên liệu tổ chức khai đã có nhà cung cấp chấp nhận đủ số lượng — tránh duyệt chiến dịch không có nguồn nguyên liệu. Tắt để duyệt không cần điều kiện này.', group: 'Chiến dịch', unit: '0/1', min: 0, max: 1, default: 1 },
  ...
  { key: 'CAMPAIGN_RECRUITMENT_CLOSE_LEAD_MINUTES', label: 'Khoảng thời gian đóng tuyển trước giờ vận hành', description: 'Số phút cần đóng tuyển trước ca đầu tiên. Dùng 360 khi chạy thật, 0–15 khi demo/test.', group: 'Chiến dịch', unit: 'phút', min: 0, max: 2880, default: 360 },
