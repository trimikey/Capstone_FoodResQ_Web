...
const FOODS = [
  { title: 'Cơm tấm sườn dư ca', category: 'cooked_meal', unit: 'portion', weight: 0.45, img: '/com-ga-hoi-an.png' },
  { title: 'Cơm gà xối mỡ', category: 'cooked_meal', unit: 'portion', weight: 0.4, img: '/com-ga-hoi-an.png' },
  { title: 'Suất cơm chay từ thiện', category: 'cooked_meal', unit: 'portion', weight: 0.4, img: '/food_lunchbox.png' },
  { title: 'Cơm trưa văn phòng', category: 'cooked_meal', unit: 'portion', weight: 0.5, img: '/food_lunchbox.png' },
  { title: 'Bún/mì xào thập cẩm', category: 'cooked_meal', unit: 'portion', weight: 0.4, img: '/com-ga-hoi-an.png' },
  ...
  { title: 'Rau củ quả cuối ngày', category: 'vegetables', unit: 'kg', weight: 1, img: '/food_salad.png' },
  { title: 'Trái cây tươi thập cẩm', category: 'fresh_fruit', unit: 'kg', weight: 1, img: '/food_salad.png' },
  { title: 'Salad rau trộn', category: 'vegetables', unit: 'portion', weight: 0.3, img: '/food_salad.png' },
